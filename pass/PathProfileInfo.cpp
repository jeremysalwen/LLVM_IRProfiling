...
static RegisterAnalysisGroup<PathProfileInfo> P("Path Profile Information");
static RegisterPass<PathProfileLoaderPass> X("path-profile-loader",
                   "Load path profile information from file",  false, true);
static RegisterAnalysisGroup<PathProfileInfo> R(X);
...
// Register this pass...
static RegisterPass<NoPathProfileInfo> Y("no-path-profile",
                   "No Path Profile Information", false, true);
static RegisterAnalysisGroup<PathProfileInfo, true> S(Y);
